...
import BorrowManagement   from './pages/admin/BorrowManagement.jsx'
import VerificationPanel  from './pages/admin/VerificationPanel.jsx'
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/admin/reservations" element={
          <ProtectedRoute allowedRoles={['admin']}><BorrowManagement /></ProtectedRoute>
        } />
        <Route path="/admin/verification" element={
          <ProtectedRoute allowedRoles={['admin']}><VerificationPanel /></ProtectedRoute>
        } />
        <Route path="/admin/logs" element={
          <ProtectedRoute allowedRoles={['admin']}><Logs /></ProtectedRoute>
        } />
